...
Lo primero es ir a la pagina de <https://www.r-project.org> e ir a la pestaña de **CRAN** y
...
Luego de eso ya podrá interactuar mejor con **R** y visualmente todo será mejor.

## Script o Bitacoras

Siempre es bueno crear unas notas de codigo. Lo puede hacer en formato _texto_ o _txt_ del block de notas de su **sistema operativo** o tambien directamente desde **R studio** de esta manera:
