...
Que son los cálculos por variable de las primeras medidas de estadística descriptiva. Para el calculo del tercer y cuarto momento hay que hallar y tener en cuenta la instalación del paquete de `moments`

```{r mom}
#Usar paquete # Momentos de la distribución
library(moments) 

#Información general de una de las variables de la base
summary(Pruebadatos$Consumo)
